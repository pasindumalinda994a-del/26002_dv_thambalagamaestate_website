...
type GalleryImage = GalleryDisplayImage & {
  kind: "image";
};
...
function chunkRows(items: GalleryImage[], size = 3): GalleryImage[][] {
...
export function GalleryHero({ images }: { images: GalleryDisplayImage[] }) {
  ...
  return (
    <div
      ref={rootRef}
      id="gallery-hero"
      className="relative w-full bg-deep-forest"
    >
      <div ref={trackRef} className="relative w-full">
        <div className="sticky top-0 h-dvh overflow-hidden">
          ...
          >
            <H1
              ref={headlineRef}
              className="max-w-[18ch] font-semibold uppercase text-cream"
            >
              {HEADLINE}
            </H1>
          </div>
